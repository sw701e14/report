...
\begin{itemize}
\item created a bike highway from the city to the university\cite{cykelhandlingsplan}.
\item built pedestrian safe zones between bus stops and bike lane\cite{pedestriansafezone}.
...
\stefan{"more usable", er det ikke lidt for upræcist? (husk gentagelse i analysis summary)}