...
\begin{enumerate}
\item To collect facts about how the current system.\alexander{What `facts'?}
...
\item How long are trips?\alexander{Better formulation}
...
They also liked the idea of adding GPS chips to the bikes in order to achieve this.\alexander{Are we providing this, and if so, in what way?}
