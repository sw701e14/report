...
\subsection{Summary} Of the three presented algorithms only the DBSCAN algorithm fits our need for a hierarchical, exclusive, partial and density based clustering algorithm.
