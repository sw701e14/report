...
The purpose of the clustering is to find the areas where bicycles are left most often, in order to make predictions on when a bike will arrive in those areas.
