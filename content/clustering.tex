...
\subsection{K-means}\bruno{Should maybe be removed for the final report because we do not use it in our project.}
...
\subsection{Hierarchical Clustering}\bruno{Should maybe be removed for the final report because we do not use it in our project.}
