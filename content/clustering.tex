...
\subsubsection{DBSCAN}\label{clustering:DBSCAN}\alexander{Write introduction to DBSCAN arguing that we choose it and why. See summary.}
...
\alexander{Slå alle algoritmer sammen til én.}
\alexander{Ret til korrekt notation og ret i forhold til wiki. regionQuery skal have data med som parameter.}
\begin{algorithm}
DBSCAN(D, eps, MinPts)\\
	C = 0\\
