...
\end{description}\alexander{Lav description om til subparagraph ligesom tidligere i rapporten?}
...
\subsection{Summary}\bruno{Hvordan argumentere vi for at bruge DBSCAN fremfor en algoritme der møder alle vores krav?} 
\alexander{Hvad skal der stå i summary? -Slet?}
