...
Partitional because we do not need a hierarchical representation of the clusters.\giovanni{``Of the clusters were hierarchically organized, it would be much easier to perform point location on them `or their convex hull' abstractions.''}
...
\noindent
\textbf{Core point} These points have at least $ MinPts $ points in a radius of $ eps $ from it. \alexander{Fix indent}
...
DBScan can have some trouble finding clusters that vary in density.\giovanni{``What does this mean? Elaborate or explain''}
