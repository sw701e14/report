...
The markov chain has a finite set of states, given by $S = \{X_0, X_1, X_2,\dots, X_{m-1}, X_m\}$\alexander{\giovanni{No it is $X_i \epsilon S$}} also known as the state space.
...
A discrete-time Markov chain can be represented as a 2-tuple\alexander{\giovanni{2-tuple == pair?}}.
