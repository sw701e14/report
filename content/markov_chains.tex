...
\bruno{\mikael{Er ikke sikker på jeg forstår denne paragraf.}}
...
\bruno{\mikael{Dette kunne snildt være defineret tidligere, da det bruges både i hotspots, her, og i tests.}}
\stefan{remember this god dammit}
...
\stefan{mangler der et y et sted eller forstår jeg det ikke?}
\mikkel{y refererer til en vilkårlig state}
...
\mikael{'System' virker meget forkert her.}
\bruno{Hvad med 'model'}
