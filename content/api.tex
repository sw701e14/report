...
\newcommand{\resource}[6]{\noindent \vfill \fbox{\begin{minipage}{\textwidth}
\begin{multicols}{2}
\begin{description}
\item[URL:]{\texttt{#1}}
...
\mikkel{WORKWORK\\
/hotspots/hotspot skal laves og /predictions skal ændres til /prediction
\stefan{mangler der en /hotspots/{hotspot} og en /prediction/{prediction}?}}

\alexander{Ret ALLE (hele rapporten) således der ikke bliver brugt paragraph som en del af sætningen. Brug description i stedet for.}
