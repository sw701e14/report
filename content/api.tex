...
\mikael{This seems like it comes out of nothing, and doesn't fit in. Perhaps a mention that this is used in the implementation to represent resources, as defined in ROA?}
...
\mikael{This seems like it should be mentioned earlier, as the criteria should also be overheld when implementing controllers}
