\subsection{Web Service API}\label{design:web_service}
...
Per default, this is \texttt{text/xml}\mikael{Lies, it is Chrome that defaults it.}, however, by adding the \texttt{Accept} header \bruno{Add source on what a header is and what accept does.}, this can be set to \texttt{application/json}.
