\subsection{Database Design}\label{database_design}
...
This table contains all information necessary for storing a GPS point as well as the field "hasNotMoved"\alexander{Maybe we should change the name to something without negation?} which indicates whether the bike is standing still or has moved since the point was inserted into the database.
