...
This, however, is deemed too far from the initial problem, as we won't be able to get any significant data without testing it on the actual bikes.\alexander{Reasonable argument?}
...
\begin{figure}[h]
\includegraphics[width=\textwidth, trim={0cm 1cm 2cm 5cm}]{our_solution.pdf}
