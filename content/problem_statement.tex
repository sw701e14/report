...
\subsection{Scope}
Due to the limited time and project members, certain restrictions will be set, as to remove focus from certain problems.
...
\mikkel{Is this not indirectly improved upon by removing stations?}
