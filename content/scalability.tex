...
\mikkel{Jeg synes der står at man sagtens kan increase men at det nemt kan føre til problemer.}
...
\mikkel{Jeg synes vi skal lave et estimat på hvornår det kunne blive aktuelt.}
...
\mikkel{Hvordan ser det ud ift skalering (og dermed synkronisering) af database?}