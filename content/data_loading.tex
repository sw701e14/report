...
The component consists of a \texttt{Data Collector} and a \texttt{Location Source} as well as a \texttt{Common} layer that contains an interface and data transfer objects.
...
In the real system an implementation will be made where the data is fetched from GPS trackers on bikes instead.

The implementation of the implementation of the bike simulation will be described in \cref{design:datasimulation}.
