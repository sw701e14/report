...
By using convex hull (\cref{} \bruno{ref til convex hull - hvis vi skriver om det ellers bare en ekstern ref}) on each cluster the number of \texttt{GPS data} is greatly minimized and is saved as a \texttt{Hotspot}.
