...
\giovanni{"Did you also consider comparable social aspects? or size of the system?"}
...
It is possible to reserve a bike,\giovanni{"How? On-line system?"} which in all cases cost 10 DKK.
...
\giovanni{Consider to compare the systems with the problems discussed in hte previous section.
