...
\bruno{Giovanni: "Did you also consider comparable social aspects? or size of the system?"}
...
It is possible to reserve a bike,\bruno{Giovanni: "How? On-line system?"} which in all cases cost 10 DKK.
...
\bruno{Giovanni: Consider to compare the systems with the problems discussed in hte previous section.
Do they solve all the mentioned problems?}