...
\end{figure}
\bruno{What is the difference between a square and circle? Is this maybe confusing? \alexander{Maybe use rectangles instead of circles for model, view, controller?}}
