...
\mikkel{Jeg har fjernet [H] fra figuren så vi ikke har en halv side whitespace.}
\end{figure}
...
\mikkel{Jeg synes vi mangler lidt argumentation for hvorfor designet ikke er inkluderet i rapporten.}
...
\mikkel{Er det ikke unødvendigt at skrive hvilke lag der er i komponenten - det skulle gerne fremgå af både figuren og de følgende paragraffer.}
...
\mikkel{Her refereres til Common, som ikke er beskrevet.}
...
\mikkel{What is the calculation of the model?}
...
\mikael{Lav referencer i stedet for at gentage}
