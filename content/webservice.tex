...
\paragraph{Uniform interface} The HTTP/1.1 specifications is used to secure an uniform interface.
...
\alexander{Læs paragraphs og se om de stadig giver mening efter at titlen ikke længere er en del af første sætning.}