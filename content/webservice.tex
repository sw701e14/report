\section{Web Service}
As we have very little knowledge of our target group\mikael{What is our target group?}, we would want our system to be as available as possible.
...
Another way to make the system available, but without making it platform-dependent, would be to create a web service, for other developers (or hobbyists) to use, making their own platform implementations.
