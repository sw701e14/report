...
\mikkel{Jeg synes ikke det er helt tydeligt at man kan sætte probability for enkelte adresser. ''adjust the probability of the system''}
...
\mikkel{Jeg synes vi skal inkludere addresserne her, for klarhedens skyld.}
...
\mikkel{Det argument holder kun så længe vi taler genereret data. Reelt data vil ikke have præcis den samme placering. Så enten synes jeg vi skal bruge et andet argument, eller også skal vi skrive at det kun relaterer sig til testen.}
...
\mikkel{Vi mangler et eksempel på sådan en værdi.}
...
\begin{figure}
	...
	\mikkel{Hvad er $d$?}
	\mikkel{Jeg synes vi skal bruge samme color-coding her som i den store tabel}
\end{figure}
...
\mikkel{Jeg synes vi skal droppe de 7.95\%. De giver ikke rigtig noget relevant information.
...
\mikkel{Det er vel muligt ved bare at kigge i databasens hotspots. Det giver ikke rigtig mening at sige at vi ikke kan oversætte adresser til hotspots når vi gør det i den forrige test.}
...
\mikkel{Agreed - I think the current method is the best}}
\mikkel{Kunne man ikke gøre det i omvendt rækkefølge - altså sådan at man først beregner de proportionale procenter og derefter bestemmer hvilke hotspots der er hvad.}
...
\mikkel{Behøver vi en conclusion sektion?}
