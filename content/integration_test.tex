...
The test shows that all GPS data points that should be in a cluster are in a cluster(The circles on \cref{fig:test:clustering}.).
This means that the clustering is quite accurate.
