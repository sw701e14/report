...
\mikkel{Does anyone have a better title for this subsection?}
The previous section described how to determine the probabilities of bikes being in a specific state.
However the user of \projectname{}\alexander{Think of a better project name.} does not seek to know what the probability, of a bike being at a station at a certain time, is.
...
This better mimics the process of waiting for a bike; rather than the probability that a bike is present when bikes continuously leave the hotspot.
