...
\item be the set of all states, $S = H \cup D$. \bruno{i am confused}
...
\stefan{nogen grund til pludselig at pagereffe?}
...
\stefan{IT IS PERFECT}} does not seek to know what the probability of a bike being at a station at a certain time is.
