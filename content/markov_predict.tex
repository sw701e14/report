...
\paragraph{An example}
Given the distribution of bikes from page \pageref{markov:example-vector} and the transition probabilities given in \Cref{markov:model:complex} on page \pageref{markov:model:complex}.
